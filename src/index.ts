...
async function showRepos(id:string,login:string){
...
async function newSearch(searchArgument:string){
...
function renderUser(mainArray:User[],qntPositions:number){
